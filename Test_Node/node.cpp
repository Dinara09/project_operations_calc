...
{
        return this->value; //вернуть содержимое  поля code_of_error
}

//получение данных о поле column_of_error
Node* Node:: get_right ()
{
    return this->right; //вернуть содержимое  поля column_of_error
}

//получение данных о поле information_of_error
Node* Node:: get_left ()
{
    return this->left; //вернуть содержимое  поля information_of_error
}

//получение данных о поле code_of_error
QString Node:: get_type_of_node ()
{
    return this->type_of_node; //вернуть содержимое  поля code_of_error
}
